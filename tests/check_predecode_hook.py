...
def main() -> None:
    ...
    def decode_hook(data_output: torch.Tensor) -> torch.Tensor:
        ...
        return torch.zeros(b, t, model.x_num, model.x_num, model.max_output_dim, device=data_output.device)

    model.embedder.decode = decode_hook
    ...
    print("Pre-decode order check passed.")
