...
expid=bcat_7
torchrun --standalone --nnodes 1 --nproc_per_node 4 main.py exp_name=bcat exp_id=${expid} compile=1 max_epoch=20 save_periodic=12 model.flex_attn=1 base_seed=570593307 &&
