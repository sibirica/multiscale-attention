...
python main.py dryrun=1 batch_size=32 data=arena compile=1 optim=wsd max_epoch=20 model=bcat_reg
# python main.py dryrun=1 batch_size=8 data=arena compile=0 optim=wsd max_epoch=20 model=bcat_reg