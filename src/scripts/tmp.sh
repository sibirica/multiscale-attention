...
torchrun --standalone --nnodes 1 --nproc_per_node 4 main.py dryrun=1 batch_size=32 data=arena compile=1 optim=nadam max_epoch=20 optim.decay=0.5 save_periodic=4
