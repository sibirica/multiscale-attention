...
expid=multiscale_bcat
python main.py exp_id=${expid} batch_size=16 data=fluids_arena compile=1 optim=muon model=multiscale_bcat model.flex_attn=1 #dryrun=1
