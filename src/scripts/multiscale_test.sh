...
#python main.py eval_only=1 use_wandb=0 data=fluids_arena exp_name=eval eval_from_exp=checkpoint/bcat/${expid} log_eval_plots=-1 exp_id=${expid} batch_size_eval=16 model=multiscale_bcat model.flex_attn=1
#python main.py eval_only=1 use_wandb=0 data=fluids_arena exp_name=eval eval_from_exp=checkpoint/bcat/${expid} log_eval_plots=-1 exp_id=${expid} batch_size_eval=16 model=multiscale_bcat model.flex_attn=1 overfit_test=1
