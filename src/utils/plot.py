...
#             cur_idx = input_plot_len + idx * 3
#             cur_target = data_all[step, ..., j]
#             plot_ax_formal(axs[j, cur_idx], cur_target, f"Target")
#             cur_output = output[output_step, ..., j]
#             plot_ax_formal(axs[j, cur_idx + 1], cur_output, "Prediction")
#             diff = cur_target - cur_output
#             # diff = np.abs(cur_target - cur_output)
#             plot_ax_formal(axs[j, cur_idx + 2], diff, "Difference", sym=True)
